    ...
    <div className='portfolio-body-div'>
        <div className='name-div'>
            ...
            <div>
                ...
                <span style={{marginLeft : "20px"}}><a href="https://drive.google.com/file/d/11jjJOCPMGI2SA7YXq4n_bA4dz-_B3r5m/view?usp=sharing" target='_blank' rel='noopener noreferrer' className='home-check-link-a-class' style={{textDecoration : "none"}}> <FontAwesomeIcon icon={faFileAlt} /> My CV</a></span>
            </div>

            {/* <br /> */}
            <div style={{marginTop : "15px"}}>
                <span style={{marginRight : "20px"}}><a href="https://www.linkedin.com/in/mahmmadsufiyan-shaik-11a2012a4/" target='_blank' rel='noopener noreferrer' className='home-check-link-a-class' style={{textDecoration : "none"}}>Linkedin</a></span>

                <span style={{marginLeft : "20px", marginRight : "20px"}}><a href="https://github.com/SkMdSufiyan" target='_blank' rel='noopener noreferrer' className='home-check-link-a-class' style={{textDecoration : "none"}}>GitHub</a></span>
            </div>
