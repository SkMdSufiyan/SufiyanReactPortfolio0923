  ...
  return (
    ...
    <div name="Experience" className="element">
          ...
          <div className='section-content-div'>
            <ul>
                <li>Research experience of 5.5 years.</li>
                <li>Teaching experience of 4 months (Jul-2017 to Oct-2017).</li>
                <li>Experience in applying Optimization algorithms and Probabilistic methods for solving engineering problems.</li>
                <li>Experience in developing fully functional Full-Stack web applications using MERN technology.</li>
